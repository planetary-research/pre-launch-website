...
Our initiative builds on the experience of several diamond open access journals have appeared in the Earth sciences since 2018. These journals include `Volcanica <http://www.jvolcanica.org/ojs/index.php/volcanica>`__, `Seismica <https://seismica.library.mcgill.ca/>`__, `Tektonika <https://tektonika.online/index.php/home>`__, `Geomorphica <https://journals.psu.edu/geomorphica/>`__, and `Sedimentologika <https://oap.unige.ch/journals/sdk/index>`__. In 2025, two additional journals are expected to launch: `Geodynamica <https://www.geodynamica.org/>`__, and `Advances in Geochemistry and Cosmochemistry <https://journals.uu.se/AGC/index>`__. Our journal is expected to launch in January 2026.
...
How to participate
------------------
The journal will be run entirely by volunteers from the planetary science community and everyone is invited to participate in its development and operations. Most of our pre-launch discussions occur in an :ref:`online forum <forum>`. We hold monthly :ref:`online meetings <meetings>` that we advertise both on the forum and through our :ref:`email distribution list <email-list>`.
